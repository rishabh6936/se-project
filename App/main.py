...
# ... (your other endpoints like get_stats, get_texts_by_topic, etc., remain the same) ...
...
async def get_texts_by_period(start_date: datetime, end_date: datetime, db_inst: Database = Depends(get_database)):
    # ... (code is unchanged)
    pass
